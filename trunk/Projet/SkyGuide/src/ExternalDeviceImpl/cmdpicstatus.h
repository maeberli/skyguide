/**
  * Class declaration file of CmdPicStatus.
  *
...
/**
  * Command class for the PicStatus trame.
  *
...
private:
    int p_status;       //< status information of pic, transported by trame
};
